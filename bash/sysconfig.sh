...
function displayhelp {
	echo "Syntax: scriptTemplate [--host|domain|ipconfig|os|cpu|memory|disk|printer]"
	echo 
	echo " --host      It is used to resolve a hostname into an IP address or vice-versa, if no arguments or options are given"
	echo " --domain    It is used to return the Network Information System (NIS) domain name of the host."
	echo " --ipconfig  It is used for displaying current network configuration information, setting up an ip address, netmask or broadcast address to an network interface, creating an alias for network interface, setting up hardware address and enable or disable network interfaces."
	echo " --os        It is used to identify the OS name and version"
	echo " --cpu       It displays information about the CPU"
	echo " --memory    Displays the memory usage"
	echo " --disk      Displays the remaining disk space"
	echo " --printer   Displays the list of printers connected to your device"
	echo
	exit 1
}
